...
def create_directory(path, show = False):
    '''
    Creates directory given path, or simply returns it if it already exists
...
def get_paths(p, show = False, discriminator = None, max_first = False):
    '''
